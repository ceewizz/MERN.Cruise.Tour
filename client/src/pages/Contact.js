...
import aboutImg from "../../client/src/about.png";
            ...
            <div className='contactForm'>
              <form id='contact-form' onSubmit={handleSubmit(onSubmit)} className="col-12 m-3" noValidate >
                ...
                <div className='row formRow'>
                  ...
                  <p></p>
                  {/* Enquiry  */}
                  <p>Contact us Toll Free at 1(800)-123-4567 <BsTelephone style={{ color: 'blue', fontSize: '30px' }} />For Hours of Operations and Office Locations.</p>
                  ...
                  <p>For Returning Customers and In Person Office Visit: Free Cancelation within the first 7 days of when the payment was received due to unforseen emergency event, must submit valid proof of emergency for a full refund, if not then a minimum 15% rebooking or restocking fee might be charged</p>
                  <br></br>
                  <br></br>
                  <h3>Contact Form</h3>
                  <br></br>
